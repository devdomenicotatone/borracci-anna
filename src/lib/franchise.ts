...
export const FRANCHISE: Franchise[] = [
  ...
  { slug: "trono-di-spade", etichetta: "Il Trono di Spade", parole: ["trono di spade", "game of thrones", "house of the dragon"] },
  { slug: "it", etichetta: "IT", parole: ["pennywise"] }, // "it" nudo e dentro "t-shirt": solo parole distintive
  { slug: "goonies", etichetta: "The Goonies", parole: ["goonies"] },
  { slug: "ritorno-al-futuro", etichetta: "Ritorno al Futuro", parole: ["ritorno al futuro", "back to the future"] },
  { slug: "il-padrino", etichetta: "Il Padrino", parole: ["padrino", "godfather"] },
  { slug: "wwe", etichetta: "WWE", parole: ["wwe"] },
  // — Cartoni & Kids — (slug allineati alla classificazione one-shot del
  // 2026-07-11: NON rinominarli, prodotti.tema li usa gia)
  { slug: "lilo-stitch", etichetta: "Lilo & Stitch", parole: ["stitch", "lilo"] },
  { slug: "topolino", etichetta: "Topolino", parole: ["topolino", "mickey mouse"] },
  { slug: "minnie-mouse", etichetta: "Minnie", parole: ["minnie"] },
  { slug: "frozen", etichetta: "Frozen", parole: ["frozen", "elsa"] },
  { slug: "cars", etichetta: "Cars", parole: ["cars"] },
  { slug: "toy-story", etichetta: "Toy Story", parole: ["toy story"] },
  { slug: "inside-out", etichetta: "Inside Out", parole: ["inside out"] },
  { slug: "minions", etichetta: "Minions", parole: ["minion"] },
  { slug: "miraculous", etichetta: "Miraculous", parole: ["miraculous", "ladybug"] },
  { slug: "bing", etichetta: "Bing", parole: ["bing"] },
  { slug: "bluey", etichetta: "Bluey", parole: ["bluey"] },
  { slug: "peppa-pig", etichetta: "Peppa Pig", parole: ["peppa"] },
  { slug: "paw-patrol", etichetta: "Paw Patrol", parole: ["paw patrol"] },
  { slug: "tartarughe-ninja", etichetta: "Tartarughe Ninja", parole: ["tartarughe ninja", "ninja turtles"] },
  { slug: "transformers", etichetta: "Transformers", parole: ["transformers"] },
  { slug: "gormiti", etichetta: "Gormiti", parole: ["gormiti"] },
  { slug: "looney-tunes", etichetta: "Looney Tunes", parole: ["looney", "titti"] },
  { slug: "betty-boop", etichetta: "Betty Boop", parole: ["betty boop"] },
  { slug: "curioso-come-george", etichetta: "Curioso come George", parole: ["curioso come george"] },
  { slug: "hello-kitty", etichetta: "Hello Kitty", parole: ["hello kitty", "kuromi"] },
  { slug: "barbie", etichetta: "Barbie", parole: ["barbie"] },
  { slug: "lol-surprise", etichetta: "L.O.L. Surprise!", parole: ["l.o.l.", "lol surprise"] },
  { slug: "chica-vampiro", etichetta: "Chica Vampiro", parole: ["chica vampiro"] },
  { slug: "soy-luna", etichetta: "Soy Luna", parole: ["soy luna"] },
  // — Anime & Manga —
  ...
  { slug: "hunter-x-hunter", etichetta: "Hunter x Hunter", parole: ["hunter x hunter"] },
  { slug: "tokyo-revengers", etichetta: "Tokyo Revengers", parole: ["tokyo revengers"] },
  { slug: "spy-x-family", etichetta: "Spy x Family", parole: ["spy x family"] },
  { slug: "dandadan", etichetta: "DanDaDan", parole: ["dandadan"] },
  // — Gaming —
  ...
  { slug: "playstation", etichetta: "PlayStation", parole: ["playstation"] },
  { slug: "brawl-stars", etichetta: "Brawl Stars", parole: ["brawl stars"] },
  { slug: "animal-crossing", etichetta: "Animal Crossing", parole: ["animal crossing"] },
  { slug: "stumble-guys", etichetta: "Stumble Guys", parole: ["stumble guys"] },
  // — Calcio (squadre) —
  ...
  { slug: "nazionale-italiana", etichetta: "Nazionale Italiana", parole: ["figc", "nazionale italiana"] },
  { slug: "torino", etichetta: "Torino", parole: ["torino f.c.", "torino fc"] },
  { slug: "tottenham", etichetta: "Tottenham", parole: ["tottenham"] },
  { slug: "benfica", etichetta: "Benfica", parole: ["benfica"] },
  { slug: "portogallo", etichetta: "Portogallo", parole: ["portogallo"] },
  { slug: "francia-fff", etichetta: "Francia", parole: ["francia"] },
  { slug: "olanda", etichetta: "Olanda", parole: ["olanda", "knvb"] },
  { slug: "champions-league", etichetta: "Champions League", parole: ["champions league"] },
  // — Motorsport —
  ...
  { slug: "bmw", etichetta: "BMW", parole: ["bmw"] },
  { slug: "ducati", etichetta: "Ducati", parole: ["ducati"] },
  { slug: "vespa", etichetta: "Vespa", parole: ["vespa"] },
  { slug: "aston-martin", etichetta: "Aston Martin", parole: ["aston martin"] },
  // — Musica (band/artisti) —
  ...
  { slug: "the-doors", etichetta: "The Doors", parole: ["the doors", "jim morrison"] },
  { slug: "motorhead", etichetta: "Motörhead", parole: ["motorhead", "motörhead"] },
  { slug: "ozzy-osbourne", etichetta: "Ozzy Osbourne", parole: ["ozzy"] },
  { slug: "tupac", etichetta: "Tupac", parole: ["tupac", "2pac"] },
  { slug: "oasis", etichetta: "Oasis", parole: ["oasis"] },
  { slug: "the-cure", etichetta: "The Cure", parole: ["the cure"] },
  { slug: "korn", etichetta: "Korn", parole: ["korn"] },
];
